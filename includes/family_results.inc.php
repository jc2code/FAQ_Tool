...
<body>
    ...
    <?php
        ...
        $resultSet = mysqli_query($conn, "SELECT * FROM tickets_1 WHERE family='".mysqli_escape_string($conn,$family)."';");       
        ...
        // Query results
        $resultSet = mysqli_query($conn, "SELECT * FROM tickets_1 WHERE family='{$family}' LIMIT $start, $rpp;");
