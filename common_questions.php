        ...
        <div class="accordion mt-3 mb-3" id="commonQuestions">
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="questionOne">
                    ...
                    <button class="accordion-button" type="button" data-bs-toggle="collapse.show" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        Is JBOD going to be added to the configurator?
                    </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="questionOne" data-bs-parent="#commonQuestions">
            ...
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="questionTwo">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse.show" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                        Configuration for (insert system name here) does not work
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="questionTwo" data-bs-parent="#commonQuestions">
                    <div class="accordion-body">
            ...
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="questionThree">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse.show" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                        Parts not listed or are missing for configuration on the configurator
                    </button>
                </h2>
                <div id="collapseThree" class="accordion-collapse collapse show" aria-labelledby="questionThree" data-bs-parent="#commonQuestions">
                    <div class="accordion-body">
            ...
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="questionFour">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse.show" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseThree">
                        What is the difference between warranties for the systems
                    </button>
                </h2>
                <div id="collapseFour" class="accordion-collapse collapse show" aria-labelledby="questionFour" data-bs-parent="#commonQuestions">
                    <div class="accordion-body">
            ...
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="questionFive">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse.show" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseThree">
                        When will a system be ready in the configurator?
                    </button>
                </h2>
                <div id="collapseFive" class="accordion-collapse collapse show" aria-labelledby="questionFive" data-bs-parent="#commonQuestions">
                    <div class="accordion-body">
